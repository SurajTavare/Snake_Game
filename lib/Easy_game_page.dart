...
class EasySnakeGamePage extends StatefulWidget {

  const EasySnakeGamePage({super.key});


  @override
  State<EasySnakeGamePage> createState() => _EasySnakeGamePageState();
}

enum Direction { up, down, left, right }

class _EasySnakeGamePageState extends State<EasySnakeGamePage> {
